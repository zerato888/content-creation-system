...
def server(tmp_path):
    ...
    (tmp_path / ".kit/cc/web/index.html").write_text("<!doctype html><title>CC</title>")
    (tmp_path / ".kit/cc/server/secret.js").write_text("nope")
    (tmp_path / ".kit/cc/config/defaults.json").write_text("{}")
    (tmp_path / ".kit/cc/web/.hidden.js").write_text("nope")
